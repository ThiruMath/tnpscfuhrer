const _works = [
  {
    ...
    "religion_context": "The religious affiliation of Tolkappiyar is debated among scholars. Some, based on the name 'Tolkappiyan,' suggest he might have been a Buddhist or a Jain. However, Mahavidwan R. Raghava Iyengar argued that Tolkappiyar adhered to Vedic traditions. Given these differing views, it is difficult to definitively ascertain Tolkappiyar's specific religious allegiance. The text itself, while mentioning deities, does not align with a single sectarian doctrine, reflecting a pre-sectarian Tamil religious landscape.",
      ...
      "books": [
        {
          ...
          "key_sutra": {
            ...
            "note": "This sutra formally recognizes the 30 primary letters of the Tamil alphabet, from which the 247 combined forms in modern Tamil are derived. Tolkappiyar's detailed 'pirappiyal' (birth of sounds) section in this book is particularly celebrated for its scientific rigor."
          }
        },
        {
        ...
        },
        {
          ...
          "key_sutra": {
            ...
            "note": "This sutra highlights that Paalai (wasteland, separation) is not an inherent landscape but rather a condition that arises from the degradation or transformation of the other four tinais, often due to drought or the lover's departure. This reflects a sophisticated ecological-emotional theory where the landscape directly mirrors the human emotional state, particularly suffering and separation. The Silappathikaram reinforces this, stating, 'Mullai and Kurinji, having deviated from their proper nature, causing trembling sorrow, take the form of Paalai.'"
          }
        }
      ]
    },
    "tinai_system": {
      "overview": "The tinai system is Tolkappiyam's central intellectual contribution, establishing a unique framework that integrates ecological classification, psychological theory, poetic convention, and a philosophical claim about the profound relationship between nature and human emotion. Tolkappiyar is credited with creating this literary tradition that intrinsically links human life experiences with specific landscapes. Unlike other ancient poetics, it creates a four-way integration where the 'uripporul' (human emotional theme) is considered paramount, even over the 'mutalporul' (land and time) and 'karupporul' (indigenous elements). Tolkappiyar himself stated, 'Uripporul allana mayangavum perumē' (other elements may mix, but the uripporul must remain distinct), emphasizing the primacy of human experience.",
      "tinais": [
        {
          "name": "Kurinji (குறிஞ்சி)",
          "region": "Mountains and mountainous regions (மலையும் மலையைச் சார்ந்த இடமும்)",
          "season": "Cool season / winter (பெரும்பொழுது: கூதிர், முன்பனி)",
          "time": "Night and pre-dawn (சிறுபொழுது: யாமம்)",
          "flower": "Kurinji (Strobilanthes kunthiana — blooms once in 12 years)",
          "tree": "Kāntaḷ (red lily)",
          "bird": "Peacock (மயில்)",
          "animal": "Elephant",
          "deity": "Murugan (முருகன்)",
          "theme": "Union — first meeting, secret trysts, the joy of love (கூடலும் கூடல் நிமித்தமும்)",
          "note": "The kurinji flower's rare 12-year bloom cycle makes it a symbol of something precious, temporary, and intensely desired, perfectly mirroring the fleeting and intense nature of first love and secret unions. This tinai captures the exhilaration and intimacy of lovers meeting in the wild, often at night."
        },
        {
          "name": "Mullai (முல்லை)",
          "region": "Forests and pastoral land (காடும் காட்டைச் சார்ந்த இடமும்)",
          "season": "Rainy season (பெரும்பொழுது: கார்)",
          "time": "Evening (சிறுபொழுது: மாலை)",
          "flower": "Jasmine (mullai)",
          "tree": "Kōngu (coral tree)",
          "bird": "Kuyil (Indian cuckoo)",
          "animal": "Cow",
          "deity": "Mayon (மாயோன் — the dark one, later identified with Vishnu/Krishna)",
          "theme": "Waiting — patient longing for the husband who has gone to war or business (இருத்தலும் இருத்தல் நிமித்தமும்)",
          "note": "The rainy season evening is depicted as a time of melancholy and longing. The jasmine blooms, perfuming an empty home, while the woman patiently awaits her husband's return, embodying steadfastness and hope amidst separation. This tinai emphasizes the virtue of patient endurance."
        },
        {
          "name": "Marutam (மருதம்)",
          "region": "Fertile farmland, river valleys (வயலும் வயலைச் சார்ந்த இடமும்)",
          "season": "All seasons (பெரும்பொழுது: ஆறு பெரும்பொழுதுகள்)",
          "time": "Dawn (சிறுபொழுது: வைகறை)",
          "flower": "Marutam blossom (Indian Kino tree)",
          "tree": "Kadamba",
          "bird": "Heron (நாரை)",
          "animal": "Buffalo",
          "deity": "Indra (இந்திரன்)",
          "theme": "Quarrel — infidelity, lovers' dispute, sulking, reconciliation (ஊடலும் ஊடல் நிமித்தமும்)",
          "note": "This tinai often portrays the complexities of urban and prosperous life, including marital discord arising from infidelity. The poems frequently feature the woman's anger and the man's attempts at reconciliation. The heron, standing alone in the paddy field, sometimes symbolizes the solitary suffering or the watchful eye in such domestic dramas."
        },
        {
          "name": "Neytal (நெய்தல்)",
          "region": "Seashore (கடலும் கடலைச் சார்ந்த இடமும்)",
          "season": "All seasons (பெரும்பொழுது: ஆறு பெரும்பொழுதுகள்)",
          "time": "Afternoon (சிறுபொழுது: எற்பாடு)",
          "flower": "Blue waterlily (neytal)",
          "tree": "Punnai (Calophyllum inophyllum)",
          "bird": "Seagull (கடல் காகம்)",
          "animal": "Shark / dolphin",
          "deity": "Varuṇan (வருணன்)",
          "theme": "Longing and anxiety — the lover has gone across the sea; will he return? (இரங்கலும் இரங்கல் நிமித்தமும்)",
          "note": "The seashore is the landscape of uncertainty and separation, where the vastness of the sea mirrors the depth of longing and anxiety. Merchants often traveled by sea, and their return was uncertain. Neytal poems capture the poignant waiting and the fear of permanent separation, often with the sound of the waves echoing the woman's sorrow."
        },
        {
          "name": "Paalai (பாலை)",
          "region": "Wasteland / forest in drought (முல்லையும் குறிஞ்சியும் திரிந்த வளம் குறைந்த இடம்)",
          "season": "Summer and drought (பெரும்பொழுது: இளவேனில், முதுவேனில், பின்பனி)",
          "time": "Midday (சிறுபொழுது: நண்பகல்)",
          "flower": "Paalai blossom / Mullai in drought",
          "tree": "Dried kōngu / cactus",
          "bird": "Cuckoo (in distress)",
          "animal": "Tiger",
          "deity": "Koṟṟavai (கொற்றவை — goddess of war and victory)",
          "theme": "Separation — the hero leaves on a long journey; the woman is left alone in harsh conditions (பிரிதலும் பிரிதல் நிமித்தமும்)",
          "note": "Paalai is the tinai of maximum suffering and desolation. It is not a naturally occurring landscape but emerges when other landscapes are ravaged by drought, symbolizing the harshness of separation. The midday sun intensifies the suffering. Poems in this tinai depict the hero's arduous journey and the woman's profound sorrow and resilience in the face of extreme hardship, often under the watchful eye of Koṟṟavai, the goddess of the harsh wilderness."
        }
      ]
    },
    ...
    "political_ethical_context": "Tolkappiyam's political claim is a powerful assertion of Tamil cultural and linguistic autonomy. In an era marked by the southward expansion of Sanskrit and the Brahminic tradition, Tolkappiyam declared that Tamil possessed its own sophisticated grammar, aesthetics, and theory of language and poetry, independent of Sanskrit. It presented Tamil not as a dialect but as a complete civilization. Ethically, the Poruladhikaram's 'akam' sections are notable for depicting love across various social strata without explicit judgment or anxiety. This portrayal of social openness, where, for instance, a Brahmin woman could love a fisherman, suggests either a description of the actual social fluidity of the early Sangam world or an idealization of how society *should* function. In either case, it constitutes a significant statement about the relationship between love, social order, and the values of Tamil society.",
    ...
    "school_syllabus": [
      {
        "grade": "Std. 6",
        "content": "Introduction to tinai system; Kurinji and Mullai overview"
      },
      {
        "grade": "Std. 8",
        "content": "Ezhutthathikaram basics; Tamil alphabet theory"
      },
      {
        "grade": "Std. 10",
        "content": "Poruladhikaram — tinai system in detail; akam/puram distinction"
      },
      {
        "grade": "Std. 11",
        "content": "Solladhikaram; uyartiṇai/aḵṟiṇai distinction; selected sutras"
      },
      {
        "grade": "Std. 12",
        "content": "Comparative analysis with later grammars; Tolkappiyam and Sangam poetry"
      },
      {
        "grade": "UG",
        "content": "Full textual study; commentary traditions (Ilampuranar, Nachinarkiniyar, Peracciriyar)"
      },
      {
        "grade": "PG",
        "content": "Critical edition scholarship; Tolkappiyam and Panini comparison; dating controversy"
      }
    ],
  ...
  },
  {
    ...
    "key_poems": [
      {
        ...
        "line_commentary": [
          {
            "lines": "1–2",
            "comment": "The cosmopolitan thesis stated as a simple fact, not an aspiration. Every town is already my own. This is not a goal to work toward — it is a perception of what is already true."
          },
          {
            "lines": "3–4",
            "comment": "The ethical consequence: if belonging is universal, then good and evil are internal matters, not things done to you by strangers. This removes the logic of tribalism at its root."
          },
          {
            "lines": "5–6",
            "comment": "Equanimity without stoic detachment. We do not perform happiness or unhappiness. We simply live without those performances."
          },
          {
            "lines": "7–10",
            "comment": "The great image: life as a raft on a flood-river. You cannot fight the current. You can only be clear-eyed about where the river goes. This is not fatalism — it is lucidity."
          },
          {
            "lines": "11–14",
            "comment": "The political conclusion. 'We have never chased greatness' — meaning: we have not competed for power. 'Like the earth that bears those who dig it' — we endure, with the patient strength of the ground itself. The 'old valor' (tol ānmai) is not martial valor — it is the valor of endurance and clarity."
          }
        ]
      },
      {
        ...
        "line_commentary": [
          {
            "lines": "1–2",
            "comment": "The boat image is precise: a boat that capsized in the middle of the river, not at the shore. Wealth fails at the moment of greatest security."
          },
          {
            "lines": "3–5",
            "comment": "Avvaiyar's ethics of generosity: the truly generous give even when they have nothing. This is not irrationality — it is the recognition that the habit of generosity must continue regardless of material circumstances, or it was never really generosity, only distribution of surplus."
          }
        ]
      },
      {
        ...
        "line_commentary": [
          {
            "lines": "1–5",
            "comment": "A riddle-poem about social gradations of trust. The answer the context implies: the king who can be trusted by all four — alone, in pairs, in small groups, in large gatherings — is the greatest. It is a poem about political trust built through shared hospitality."
          }
        ]
      }
    ],
    ...
    "school_syllabus": [
      {
        "grade": "Std. 9",
        "content": "Purananuru 192 (Kaniyan Pungundranar) — full text and basic commentary"
      },
      {
        "grade": "Std. 10",
        "content": "Purananuru 182 (Avvaiyar) — generosity; selected praise poems"
      },
      {
        "grade": "Std. 11",
        "content": "Kañci poems on impermanence; political poems; Kapilar elegies for Pari"
      },
      {
        "grade": "Std. 12",
        "content": "The anthology as political document; war poetry in context"
      },
      {
        "grade": "UG",
        "content": "Full text reading; commentary traditions; social history from Purananuru"
      },
      {
        "grade": "PG",
        "content": "Critical edition; comparison with Akananuru and other puram texts; archaeological corroboration"
      }
    ],
  ...
  },
  {
    ...
    "school_syllabus": [
      {
        "grade": "Std. 6",
        "content": "Selected kurals from Aram: Kural 1, 2; gratitude; truth"
      },
      {
        "grade": "Std. 7",
        "content": "Hospitality (chapters 8–9); not lying; domestic virtue"
      },
      {
        "grade": "Std. 8",
        "content": "Education (chapters 39–40); compassion; anger management"
      },
      {
        "grade": "Std. 9",
        "content": "Porul — governance basics; knowing the right moment; friendship"
      },
      {
        "grade": "Std. 10",
        "content": "Full Aram chapters on compassion and non-killing; selected Porul"
      },
      {
        "grade": "Std. 11",
        "content": "Political theory chapters (50–60); Inbam overview"
      },
      {
        "grade": "Std. 12",
        "content": "Kural as literary masterpiece; metre; commentators compared"
      },
      {
        "grade": "UG",
        "content": "Full text; 10 commentators compared; Jain vs Hindu vs secular readings"
      },
      {
        "grade": "PG",
        "content": "Critical edition; dating; translation history (80+ languages); political reception"
      }
    ],
  ...
  },
  {
    ...
    "school_syllabus": [
      {
        "grade": "Std. 9",
        "content": "Overview: story, structure, three cities"
      },
      {
        "grade": "Std. 10",
        "content": "Puhar description; Kovalan-Kannagi story"
      },
      {
        "grade": "Std. 11",
        "content": "Madurai book — execution, Kannagi's accusation, burning of Madurai"
      },
      {
        "grade": "Std. 12",
        "content": "Silappadikaram as social document; music and dance theory in the text"
      },
      {
        "grade": "UG",
        "content": "Full text; commentary tradition; archaeological evidence for the cities"
      },
      {
        "grade": "PG",
        "content": "Feminist readings; political theory; Silappadikaram and Manimekalai as paired texts"
      }
    ],
